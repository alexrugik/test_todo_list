!function(modules) {
    ...
    "use strict";
    __webpack_require__(1), angular.module("app", [ "ngMockE2E", "ui.router", "restmod", __webpack_require__(4), __webpack_require__(5), __webpack_require__(10), __webpack_require__(17), __webpack_require__(18), __webpack_require__(19) ]).config(__webpack_require__(20));
}, function(module, exports, __webpack_require__) {
    "use strict";
    ...
    (function(__) {
        ...
        function HttpBackend($httpBackend) {
            ...
            $httpBackend.when("GET", "/api/users/").respond(function(method, url, data, headers, params) {
                return [ 200, listOfUsers ];
            }), $httpBackend.when("GET", /^\/api\/users\/(.+)/, void 0, void 0, [ "id" ]).respond(function(method, url, data, headers, params) {
                return [ 200, listOfUsers[parseInt(params.id)] ];
            }), $httpBackend.when("GET", /^\/api\/users\?([a-zA-Z]+)\=(.+)$/).respond(function(method, url, data, headers, params) {
                return [ 200, __.filter(listOfUsers, params) ];
            }), $httpBackend.when("POST", "/api/users").respond(function(method, url, data, headers, params) {
                if (!data) return [ 500, "error" ];
                var user = new User();
                return data.firstName && (user.setFirstName = data.firstName), data.lastName && (user.setLastName = data.lastName), 
                data.age && (user.setAge = data.age), listOfUsers.push(user), [ 200, {
                    result: "ok"
                } ];
        ...
        var Users = __webpack_require__(8), User = __webpack_require__(9);
        module.exports = "app.httpBackend", angular.module("app.httpBackend", []).run(HttpBackend), 
        HttpBackend.$inject = [ "$httpBackend" ];
        var users = new Users(), alex = new User();
        alex.setFirstName("Alex"), alex.setLastName("Ruzhinskiy"), alex.setAge(27), alex.setCounty("Ukraine"), 
        alex.getLocation("11000&1090000");
        var dmitriy = new User();
        dmitriy.setFirstName("Dmitriy"), dmitriy.setLastName("Gotra"), dmitriy.setAge(25), 
        dmitriy.setCounty("Slovakia"), dmitriy.getLocation("11000&1090000");
        var slava = new User();
        slava.setFirstName("Slava"), slava.setLastName("Ruzhinskiy"), slava.setAge(23), 
        slava.setCounty("Ukraine"), slava.getLocation("11000&1090000");
        var oleg = new User();
        oleg.setFirstName("Oleg"), oleg.setLastName("Kovalenko"), oleg.setAge(40), oleg.setCounty("Ukraine"), 
        oleg.getLocation("11000&1090000");
        var oleg2 = new User();
        oleg2.setFirstName("Oleg"), oleg2.setLastName("Kamus"), oleg2.setAge(34), oleg2.setCounty("Ukraine"), 
        oleg2.getLocation("11000&1090000");
        var vasya = new User();
        vasya.setFirstName("Vasya"), vasya.setLastName("Andro"), vasya.setAge(18), vasya.setCounty("USA"), 
        vasya.getLocation("11000&1090000");
        var vladimir = new User();
        vladimir.setFirstName("Vladimir"), vladimir.setLastName("Melnik"), vladimir.setAge(26), 
        vladimir.setCounty("Ukraine"), vladimir.getLocation("11000&1090000"), users.addUser(alex), 
        users.addUser(slava), users.addUser(oleg), users.addUser(oleg2), users.addUser(vasya), 
        ...
        (function() {
            ...
            var deburredLetters = {
                ...
                function assignMergeValue(object, key, value) {
                    (value === undefined || eq(object[key], value)) && ("number" != typeof key || value !== undefined || key in object) || baseAssignValue(object, key, value);
                }
                ...
                function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
                    ...
                    newValue = baseClone(srcValue, !0)) : newValue = objValue : isCommon = !1), isCommon && (stack.set(srcValue, newValue), 
                ...
                function shuffleSelf(array, size) {
                    ...
                    for (size = size === undefined ? length : baseClamp(size, 0, length); ++index < size; ) {
                ...
                function isEmpty(value) {
                    ...
                    if (isPrototype(value)) return !nativeKeys(value).length;
                ...
                } : identity, baseSetToString = nativeDefineProperty ? function(func, string) {
    ...
    function Users() {
        ...
        var users = [];
        this.getUsers = getUsers, this.addUser = addUser;
    }
    ...
    function User() {
        ...
        var firstName, lastName, age, location, country, id = User.id++;
        this.getId = getId, this.getFirstName = getFirstName, this.setFirstName = setFirstName, 
        this.getLastName = getLastName, this.setLastName = setLastName, this.getAge = getAge, 
        this.setAge = setAge, this.getLocation = getLocation, this.setLocation = setLocation, 
        this.getCounty = getCountry, this.setCounty = setCountry;
    }
    module.exports = User, User.id = 0;
}, function(module, exports, __webpack_require__) {
    "use strict";
    module.exports = "app.core", angular.module("app.core", [ __webpack_require__(11), __webpack_require__(12), __webpack_require__(13), __webpack_require__(14), __webpack_require__(15), __webpack_require__(16) ]);
}, function(module, exports) {
    "use strict";
    ...
    function MainController($state, $rootScope, $timeout, $interval, user, $http) {
        ...
        function destroy() {}
        var $ctrl = this;
        $ctrl.$onInit = init, $ctrl.$onDestroy = destroy, $ctrl.user1 = user.$find(1);
        var anton = user.$build({
            firstName: "Anton",
            lastName: "Sviderskiy",
            age: 30
        });
        anton.$save();
        var testUser = user.$search({
            firstName: "Anton"
        });
